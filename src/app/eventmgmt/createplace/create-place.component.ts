...
export class CreatePlaceComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,private router: Router,private formBuilder: FormBuilder, private sessionService: SessionService, private messageService: MessageService) { }
  ...
  submitForm() {
    if (this.locationForm.valid) {
      console.log("proposesubmit::::>>>>"+this.locationForm.valid);
      this.sessionService.createPlacePropose(this.locationForm.value).subscribe(
        () => {
          ...
          this.clearForm();
          this.router.navigate(['event-viewlocation-details', this.eventId]);
        },
        (error) => {
