...
@Component({
  selector: 'app-eventviewdetails',
  standalone: true,
  imports: [MatCardModule],
  templateUrl: './eventviewlocationdetails.component.html',
  styleUrl: './eventviewlocationdetails.component.css'
})
export class EventviewlocationdetailsComponent implements OnInit {
  eventId!: number
